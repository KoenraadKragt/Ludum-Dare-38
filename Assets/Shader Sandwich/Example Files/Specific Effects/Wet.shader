...
Properties {
	...
	_SpecColor ("Specular Color", Color) = (0.6544118,0.6544118,0.6544118,1)
	_SSSRain_Scale ("Rain Scale", Float) = 70.000000000
	_SSSRain_Strength ("Rain Strength", Range(0.000000000,3.000000000)) = 1.000000000
	_SSSPuddle_Sizes ("Puddle Sizes", Float) = 2.000000000
	_SSSPuddle_Contrast ("Puddle Contrast", Range(0.000000000,3.000000000)) = 1.468750000
	_SSSPuddle_Darkening ("Puddle Darkening", Range(0.000000000,1.000000000)) = 1.000000000
}
...
float4 _MainTex_ST;
				float _Shininess;
								float _SSSRain_Scale;
				float _SSSRain_Strength;
				float _SSSPuddle_Sizes;
				float _SSSPuddle_Contrast;
				float _SSSPuddle_Darkening;
...
cDiff += cAmb;
	...
	//Generate layers for the Normals channel.
		//Generate Layer: Normal Map Copy Copy
			//Sample parts of the layer:
				half4 Normal_Map_Copy_CopyNormals_Sample2 = (PerlinNoise2D(((((((d.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale))+float2(0,0)))) + float2(0.048, 0))*3)*3)+1)/2;
				half4 Normal_Map_Copy_CopyNormals_Sample3 = (PerlinNoise2D(((((((d.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale))+float2(0,0)))) + float2(0, 0.048))*3)*3)+1)/2;
				half4 Normal_Map_Copy_CopyNormals_Sample1 = (PerlinNoise2D(((((((d.uvTexcoord.xy*float2(_SSSRain_Scale,_SSSRain_Scale))+float2(0,0)))))*3)*3)+1)/2;

			//Apply Effects:
				Normal_Map_Copy_CopyNormals_Sample1 = (float4(normalize(float3(((Normal_Map_Copy_CopyNormals_Sample1.r-Normal_Map_Copy_CopyNormals_Sample2.r)*_SSSRain_Strength),((Normal_Map_Copy_CopyNormals_Sample1.r-Normal_Map_Copy_CopyNormals_Sample3.r)*_SSSRain_Strength),1)),Normal_Map_Copy_CopyNormals_Sample1.a));

			//Set the channel to the new color
				d.Normal = Normal_Map_Copy_CopyNormals_Sample1.rgb;
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: Specular Copy
			//Sample parts of the layer:
				half4 Specular_CopyAlbedo_Sample1 = (PerlinNoise2D((((((d.uvTexcoord.xy*float2(_SSSPuddle_Sizes,_SSSPuddle_Sizes)))))*3)*3)+1)/2;

			//Apply Effects:
				Specular_CopyAlbedo_Sample1.rgb = lerp(float3(0.5,0.5,0.5),Specular_CopyAlbedo_Sample1.rgb,_SSSPuddle_Contrast);
			...
			//Blend the layer into the channel using the Multiply blend mode
				d.Albedo = lerp(d.Albedo,d.Albedo*Specular_CopyAlbedo_Sample1.rgb,_SSSPuddle_Darkening);
	...
	//Generate layers for the Specular channel.
		//Generate Layer: Specular 2
			...
			//Set the channel to the new color
				d.Specular = Specular_2Specular_Sample1.rgb;

		//Generate Layer: Specular
			//Sample parts of the layer:
				half4 SpecularSpecular_Sample1 = (PerlinNoise2D((((((d.uvTexcoord.xy*float2(_SSSPuddle_Sizes,_SSSPuddle_Sizes)))))*3)*3)+1)/2;

			//Apply Effects:
				SpecularSpecular_Sample1.rgb = lerp(float3(0.5,0.5,0.5),SpecularSpecular_Sample1.rgb,_SSSPuddle_Contrast);
...
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^