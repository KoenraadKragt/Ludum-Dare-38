...
Properties {
	...
	_SSSDistance ("Distance", Float) = 2.540000000
	_SSSFalloff ("Falloff", Float) = 4.060000000
	_SSSWax_Level ("Wax Level", Range(0.000000000,1.000000000)) = 0.391752600
}
...
float4 _MainTex_ST;
	...
	//Generate layers for the Emission channel.
		//Generate Layer: Scattering
			//Sample parts of the layer:
				half4 ScatteringEmission_Sample1 = float4((((mul(unity_WorldToObject, float4(d.worldPos,1)).xyz))),1);

			//Apply Effects:
				ScatteringEmission_Sample1.rgb = ((distance(ScatteringEmission_Sample1.rgb.xyz,float3(0,0,0))).rrrr);
				ScatteringEmission_Sample1.rgb = pow(ScatteringEmission_Sample1.rgb,_SSSFalloff);
				ScatteringEmission_Sample1.rgb = (ScatteringEmission_Sample1.rgb*_SSSDistance);
			...
			//Blend the layer into the channel using the Add blend mode
				d.Emission += ScatteringEmission_Sample1.rgba*_SSSWax_Level;

	d.Emission.rgb*=d.Albedo;
				fixed3 worldN;
...
Color#!S2#^Vec#^0.5588235,0.4457553,0.3246107,1#^CC0#?Color
...
VisName#!S2#^Text#^Distance#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.8,0.8,0.8,1#^CC0#?Color
Number#!S2#^Float#^2.54#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
...
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSDistance#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
BeginShaderInput
Type#!S2#^Float#^3#^CC0#?Type
VisName#!S2#^Text#^Falloff#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.8,0.8,0.8,1#^CC0#?Color
Number#!S2#^Float#^4.06#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
MainType#!S2#^Float#^0#^CC0#?MainType
SpecialType#!S2#^Float#^0#^CC0#?SpecialType
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSFalloff#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
BeginShaderInput
Type#!S2#^Float#^4#^CC0#?Type
VisName#!S2#^Text#^Wax Level#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.8,0.8,0.8,1#^CC0#?Color
Number#!S2#^Float#^0.3917526#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
MainType#!S2#^Float#^0#^CC0#?MainType
SpecialType#!S2#^Float#^0#^CC0#?SpecialType
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSWax_Level#^CC0#?CustomFallback
