...
{
internal class ShaderToasterStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent aoStrengthText = new GUIContent("AO Strength", "Vertex Ambient Occlusion Strength");
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_MaterialEditor.RangeProperty(aoStrength,"AO Strength");
		}
		if (EditorGUI.EndChangeCheck())
		{
