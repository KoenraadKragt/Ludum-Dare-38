...
float4 _MainTex_ST;
	...
	//Generate layers for the Diffuse channel.
		...
		//Generate Layer: Texture3
			//Sample parts of the layer:
				half4 Texture3Albedo_Sample1 = _SSSTexture3_aMain_Color;

			//Blend the layer into the channel using the Subtract blend mode
				d.Albedo -= Texture3Albedo_Sample1.rgb*_SSSDespill*Mask0;
	...
	//Generate layers for the Alpha channel.
		...
		//Generate Layer: Alpha3
			...
			//Blend the layer into the channel using the Mix blend mode
				d.Alpha = lerp(d.Alpha,Alpha3Alpha_Sample1.r,Mask0);

		//Generate Layer: Mask0 Copy
			//Sample parts of the layer:
				half4 Mask0_CopyAlpha_Sample1 = float4(d.Alpha.rrr,1);
...
VisName#!S2#^Text#^Despill#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.8,0.8,0.8,1#^CC0#?Color
Number#!S2#^Float#^0.3967611#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
...
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSDespill#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
BeginShaderInput
Type#!S2#^Float#^4#^CC0#?Type
...
Number#!S2#^Float#^0.2125#^CC0#?Number
...
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0,0,0,0#^CC0#?Color
Number#!S2#^Float#^13.46875#^CC0#?Number
Range0#!S2#^Float#^1#^CC0#?Range0
...
VisName#!S2#^Text#^Texture3 - Main Color#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.2452422,0.6176471,0.34382,1#^CC0#?Color
Number#!S2#^Float#^0.2235294#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
MainType#!S2#^Float#^0#^CC0#?MainType
SpecialType#!S2#^Float#^0#^CC0#?SpecialType
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSTexture3_aMain_Color#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
ShaderName#!S2#^Text#^Shader Sandwich/Specific/Color Key#^CC0#?ShaderName
...
X#!S2#^Float#^0.2452422#^CC0 #^ 4#?X
Y#!S2#^Float#^0.6176471#^CC1 #^ 4#?Y
Z#!S2#^Float#^0.34382#^CC2 #^ 4#?Z
W#!S2#^Float#^0#^CC0#?W
EndShaderEffect
BeginShaderEffect
...
Main Color#!S2#^Vec#^0.2452422,0.6176471,0.34382,1#^CC0 #^ 4#?Main Color
Second Color#!S2#^Vec#^0,0,0,1#^CC0#?Second Color
...
Map Local#!S2#^Toggle#^False#^CC0#?Map Local
Use Alpha#!S2#^Toggle#^False#^CC0#?Use Alpha
Mix Amount#!S2#^Float#^0.3967611#^CC0 #^ 1#?Mix Amount
Use Fadeout#!S2#^Toggle#^False#^CC0#?Use Fadeout
Fadeout Limit Min#!S2#^Float#^0#^CC0#?Fadeout Limit Min
Fadeout Limit Max#!S2#^Float#^10#^CC0#?Fadeout Limit Max
Fadeout Start#!S2#^Float#^3#^CC0#?Fadeout Start
...
Cubemap#!S2#^Cubemap#^#^CC0#?Cubemap
Noise Dimensions#!S2#^Type#^0#^CC0#?Noise Dimensions
Color#!S2#^Vec#^0.2452422,0.6176471,0.34382,1#^CC0 #^ 4#?Color
Color 2#!S2#^Vec#^0,0,0,1#^CC0#?Color 2
...
IsVisible#!S2#^Toggle#^True#^CC0#?IsVisible
UseAlpha#!S2#^Float#^0#^CC0#?UseAlpha
Add#!S2#^Float#^0.2125#^CC0 #^ 2#?Add
EndShaderEffect
BeginShaderEffect
TypeS#!S2#^Text#^SSEContrast#^CC0#?TypeS
IsVisible#!S2#^Toggle#^True#^CC0#?IsVisible
UseAlpha#!S2#^Float#^0#^CC0#?UseAlpha
Contrast#!S2#^Float#^13.46875#^CC0 #^ 3#?Contrast
EndShaderEffect
BeginShaderEffect
