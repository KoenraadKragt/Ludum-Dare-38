...
///////////////////////////////////////////////
	...
	static public void SetLabelSize(int S){
		if (ShaderSandwich.Instance.CurInterfaceStyle==InterfaceStyle.Modern)
			GUI.skin.label.fontSize = (int)((S*((float)ShaderSandwich.Instance.InterfaceSize/12f)));
		else
...
//		Debug.Log(parts[0].Trim());
	...
	static public void AddProSkin_Real(bool FI,Vector2 WinSize){
		...
		GUI.skin = SSSkin;
		float Val = GetVal(ShaderSandwich.Instance.InterfaceColor);
		...
		BackgroundColor = new Color(0.18f,0.18f,0.18f,1);
		
		ShaderSandwich.SCSkin.window.onNormal.textColor = SetVal(ShaderSandwich.Instance.InterfaceColor,1f);
		
		ShaderSandwich.SCSkin.window.fontSize = ShaderSandwich.Instance.InterfaceSize;
		GUI.skin.label.fontSize = ShaderSandwich.Instance.InterfaceSize;
		if (ShaderSandwich.Instance.CurInterfaceStyle==InterfaceStyle.Modern)
		GUI.skin.box.fontSize = ShaderSandwich.Instance.InterfaceSize;
		else
		GUI.skin.box.fontSize = 11;
			...
			//GUI.backgroundColor = new Color(0.4f*Val,0.4f*Val,0.4f*Val,1f);
			else
			GUI.backgroundColor = new Color(0.25f,0.25f,0.25f,1f);
			//else
