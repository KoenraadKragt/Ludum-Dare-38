...
//Settings
	...
	public ShaderVar TechZWrite = new ShaderVar("BaseZWrite",new string[]{"Auto","On","Off"},new string[]{"","",""},new string[]{"On","On","Off"}); 
	public ShaderVar TechZTest = new ShaderVar("Ztest",new string[]{"Less","Greater","LEqual","GEqual","Equal","NotEqual","Always"},new string[]{"","","","","","",""},new string[]{"Less","Greater","LEqual","GEqual","Equal","NotEqual","Always"}); 
	...
	public ShaderVar MiscDeferred = new ShaderVar("Deferred",true);
	public ShaderVar MiscForward = new ShaderVar("Forward",true);
	public ShaderVar MiscForwardAdd = new ShaderVar("Forward Add",true);
	public ShaderVar MiscShadowCaster = new ShaderVar("Shadow Caster",true);
	...
	//public ShaderVar MiscVertexToastie = new ShaderVar("Vertex Toastie Support",true);
	public ShaderVar MiscVertexToastie = new ShaderVar("Vertex Toastie Support Type",true);
	public ShaderVar MiscVertexToastieOptimized = new ShaderVar("Vertex Toastie Optimized",false);
	
	//INDIRECT - AMBIENT OCCLUSION + SUBSURFACE SCATTERING
	public ShaderVar IndirectControl = new ShaderVar("Indirect Control",new string[]{"Manual","Auto","Auto Optimized"});
	//AO
	public ShaderVar IndirectAmbientOcclusionOn = new ShaderVar("Indirect Ambient Occlusion On",false);
	public ShaderVar IndirectAmbientOcclusionControl = new ShaderVar("Indirect Ambient Occlusion Control",new string[]{"Auto","Manual"});
	public ShaderVar IndirectAmbientOcclusionRealtime = new ShaderVar("Indirect Ambient Occlusion Realtime",new string[]{"Baked","Realtime"});
	public ShaderVar IndirectAmbientOcclusionOptimizedType = new ShaderVar("Indirect Ambient Occlusion Optimized Type",new string[]{"Optimized","Really Optimized"});
	public ShaderVar IndirectAmbientOcclusionOptimized = new ShaderVar("Indirect Ambient Occlusion Optimized",false);
	public ShaderVar IndirectAmbientOcclusionStrength = new ShaderVar("Indirect Ambient Occlusion Strength",1f);
	public ShaderVar IndirectAmbientOcclusionPushback = new ShaderVar("Indirect Ambient Occlusion Pushback",1f);
	
	public ShaderVar IndirectAmbientOcclusionDisplayType = new ShaderVar("Indirect Ambient Occlusion Display Type",new string[]{"Ambient","Ambient+Diffuse","AO Only"});
	
	//Subsurface Scattering
	public ShaderVar IndirectSubsurfaceScatteringOn = new ShaderVar("Indirect Subsurface Scattering On",false);
	public ShaderVar IndirectSubsurfaceScattering = new ShaderVar("Indirect Subsurface Scattering Enabled",new string[]{"Baked","Realtime"});
	public ShaderVar IndirectSubsurfaceScatteringMix = new ShaderVar("SSS Mix",0.5f);
	public ShaderVar IndirectSubsurfaceScatteringUseThickness = new ShaderVar("SSS Use Thickness",true);
	public ShaderVar IndirectSubsurfaceScatteringAmbient = new ShaderVar("SSS Constant Scatter",0.1f);
	public ShaderVar IndirectSubsurfaceScatteringDensity = new ShaderVar("SSS Density",40f);
	public ShaderVar IndirectSubsurfaceScatteringDistortion = new ShaderVar("SSS Fresnel Distortion",0.25f);
	public ShaderVar IndirectSubsurfaceScatteringScale = new ShaderVar("SSS Fresnel Brightness",1f);
	public ShaderVar IndirectSubsurfaceScatteringThinness = new ShaderVar("SSS Fresnel Thinness",1f);
	
	public ShaderVar IndirectSubsurfaceScatteringColor = new ShaderVar("SSS Color",new ShaderColor(1f,1f,1f,1f));
	...
	public ShaderVar MaxLightSpecularHardness = new ShaderVar("Max Light Spec Hardness",0.9f);
	...
	public ShaderVar TransparencyCorrectShadows = new ShaderVar("Correct Shadows",true); 
	public ShaderVar TransparencyPBR = new ShaderVar("Use PBR",true); 
	public ShaderVar TransparencyAlphaToCoverage = new ShaderVar("Alpha To Coverage",false); 
	public ShaderVar TransparencyPreMult = new ShaderVar("Pre-MultiplyOld",new string[]{"Off","In Assets","In Shader"},new string[]{"","",""},new string[]{"Off","In Assets","In Shader"}); 
	public ShaderVar TransparencyPreMult2 = new ShaderVar("Pre-Multiply",false); 
	public ShaderVar TransparencyReceive = new ShaderVar("Receive Shadows",false);
	public ShaderVar TransparencyZWriteType = new ShaderVar("ZWrite Type",new string[]{"Off","Full","Cutoff"},new string[]{"","","",""},new string[]{"Off","Full","Cutoff"});
	...
	public ShaderVar ParallaxDepthCorrection = new ShaderVar("Parallax Depth Correction",false);
	...
	//ShaderSandwich Interaction Stuff
	public ShaderVar PokeOn = new ShaderVar("Poke On",false);
	public ShaderVar PokeCount = new ShaderVar("Poke Count",4f);
	public ShaderVar PokeLine = new ShaderVar("Poke Line",true);
	public ShaderVar PokeInteraction = new ShaderVar("Poke Interaction",new string[]{"None","Collapse","Bounce","Ripple"},new string[]{"","","",""},new string[]{"","","",""});
	public ShaderVar PokeFloat3s = new ShaderVar("Poke Float3 Count",0f);
	public ShaderVar PokeFloats = new ShaderVar("Poke Float Count",0f);
	public ShaderVar PokeCustom = new ShaderVar("Poke Custom",false);
...
//LayerLists
	...
	public void GetMyShaderVars(List<ShaderVar> SVs){
		...
		SVs.Add(IndirectControl);
		SVs.Add(IndirectAmbientOcclusionOn);
		SVs.Add(IndirectAmbientOcclusionControl);
		SVs.Add(IndirectAmbientOcclusionRealtime);
		SVs.Add(IndirectAmbientOcclusionOptimized);
		SVs.Add(IndirectAmbientOcclusionOptimizedType);
		SVs.Add(IndirectAmbientOcclusionStrength);
		SVs.Add(IndirectAmbientOcclusionPushback);
		SVs.Add(IndirectAmbientOcclusionDisplayType);
		
		SVs.Add(IndirectSubsurfaceScatteringOn);
		SVs.Add(IndirectSubsurfaceScattering);
		SVs.Add(IndirectSubsurfaceScatteringMix);
		SVs.Add(IndirectSubsurfaceScatteringUseThickness);
		SVs.Add(IndirectSubsurfaceScatteringAmbient);
		SVs.Add(IndirectSubsurfaceScatteringDensity);
		SVs.Add(IndirectSubsurfaceScatteringDistortion);
		SVs.Add(IndirectSubsurfaceScatteringScale);
		SVs.Add(IndirectSubsurfaceScatteringThinness);
		SVs.Add(IndirectSubsurfaceScatteringColor);
		...
		SVs.Add(TransparencyCorrectShadows);
		SVs.Add(TransparencyPBR);
		SVs.Add(TransparencyAlphaToCoverage);
		SVs.Add(TransparencyPreMult2);
		...
		SVs.Add(ParallaxDepthCorrection);
	...
	public string GeneratePassGroup(ShaderGenerate SG,float d){
		string ShaderCode = "";
			GenerateUsed(SG);
			SG.Dist = d;
			if (TransparencyOn.On&&TransparencyType.Type==1&&TransparencyZWriteType.Type==1)
				ShaderCode += GenerateForwardMask(SG);
			if (TransparencyOn.On&&TransparencyType.Type==1&&TransparencyZWriteType.Type==2){
				SG.PassSubset = "Mask";
				...
				if (SG.UseLighting&&MiscDeferred.On&&IsPBR)
					ShaderCode += GenerateDeferred(SG);
			...
			if (SG.UseLighting&&MiscDeferred.On&&IsPBR)
				ShaderCode += GenerateDeferred(SG);
			//if (ShaderLayersVertex.SLs.Count>0)
			if (MiscShadowCaster.On)
				ShaderCode += GenerateShadowCasterPass(SG);
		return ShaderCode;
	}
	...
	public string GeneratePassStart(ShaderGenerate SG,string PassName, string LightMode, string MultiCompile, string Define){
		return GeneratePassStart(SG,PassName,LightMode,MultiCompile,Define,"");
	}
	public string GeneratePassStart(ShaderGenerate SG,string PassName, string LightMode, string MultiCompile, string Define, string Exclude){
		string ShaderCode = "";
		ShaderCode +=
		...
		if (MiscFog.On&&!SG.U4&&SG.Pass != "Deferred")
			ShaderCode +=
		...
		if (!MiscLightmap.On||SG.Pass=="Mask"||SG.Pass == "ShadowCaster")
	...
	public string GenerateUniforms(ShaderGenerate SG){
		string ShaderCode = "			//Make our inputs accessible by declaring them here.\n";
			...
			foreach(ShaderInput SI in SG.Base.ShaderInputs){
				if (SI.InEditor||SI.SpecialType==InputSpecialTypes.None||SG.Temp){
					ShaderCode += "				";
					if (SI.Type==0){
	...
	public string GenerateLayers(ShaderGenerate SG, ShaderLayerList SLL,string Function)
	{
		...
		if (SLL.SLs.Count>0){
			...
			foreach (ShaderLayer SL in SLL.SLs)
			{
				...
				if (SG.InVertex){
						//Debug.Log("Am In Vertexs");
						//Debug.Log(SG.VertexSpace);
						//Debug.Log((VertexSpaces)SL.VertexSpace.Float);
					if (SG.VertexSpace != (VertexSpaces)SL.VertexSpace.Float){
						//Debug.Log("Time to switch space");
...
//						Debug.Log(PixelColor);
		...
		string ShaderCode = "";
			...
			if (SG.UsedVertex){
				...
				if (IndirectAmbientOcclusionOn.On){
					...
					if (IndirectAmbientOcclusionRealtime.Type==0)
						ShaderCode+="				float AmbientOcclusion = o.color.a;";
				
					if (IndirectAmbientOcclusionOptimized.On==true&&IndirectAmbientOcclusionOptimizedType.Type==0){
						if (IndirectAmbientOcclusionControl.Type==0)
							ShaderCode+= "				o.color.a = (1-(testpow((1-AmbientOcclusion),_AOPower)*_AOStrength));\n";
						else
							ShaderCode+= "				o.color.a = (1-(testpow((1-AmbientOcclusion),"+IndirectAmbientOcclusionPushback.Get()+")*"+IndirectAmbientOcclusionStrength.Get()+"));\n";
					}
					else if (IndirectAmbientOcclusionOptimized.On==true&&IndirectAmbientOcclusionOptimizedType.Type==0){
						ShaderCode+= "				o.color.a = AmbientOcclusion;\n";
					}
				}
			}
			...
			if (PokeOn.On){
				ShaderCode+=			"				//Poke Stuff\n";
				ShaderCode+=			"					UsefulData d;\n";
				ShaderCode+=			"					UnityGI gi;\n";
				for(i = 0; i<PokeCount.Float;i++){
					string si = i.ToString();
					if (PokeLine.On){
						ShaderCode+=		"					float _Poke"+si+"Projection = PokeLineProjection(_Poke"+si+"PreviousPosition,_Poke"+si+"Position,worldPos);\n";
						ShaderCode+=		"					float3 _Poke"+si+"LPosition = lerp(_Poke"+si+"PreviousPosition,_Poke"+si+"Position,_Poke"+si+"Projection);\n";
						ShaderCode+=		"					float _Poke"+si+"Distance = distance(worldPos,_Poke"+si+"LPosition);\n";
						ShaderCode+=		"					float3 _Poke"+si+"LVelocity = lerp(_Poke"+si+"PreviousVelocity,_Poke"+si+"Velocity,_Poke"+si+"Projection);\n";
						ShaderCode+=		"					float _Poke"+si+"LTime = lerp(_Poke"+si+"PreviousTime,_Poke"+si+"Time,_Poke"+si+"Projection);\n";
						ShaderCode+=		"					float _Poke"+si+"LTimeNormalized = lerp(_Poke"+si+"PreviousTimeNormalized,_Poke"+si+"TimeNormalized,_Poke"+si+"Projection);\n";
						ShaderCode+=		"					float _Poke"+si+"LMaxDistance = lerp(_Poke"+si+"PreviousMaxDistance,_Poke"+si+"MaxDistance,_Poke"+si+"Projection);\n";
						
						for(int ii = 0; ii<PokeFloats.Float;ii++)
							ShaderCode+="				float  _Poke"+si+"LCustomF_"+ii.ToString()+" = lerp(_Poke"+si+"PreviousCustomF_"+ii.ToString()+",_Poke"+si+"CustomF_"+ii.ToString()+",_Poke"+si+"Projection);\n";
						for(int ii = 0; ii<PokeFloat3s.Float;ii++)
							ShaderCode+="				float3 _Poke"+si+"LCustomF3_"+ii.ToString()+" = lerp(_Poke"+si+"PreviousCustomF3_"+ii.ToString()+",_Poke"+si+"CustomF3_"+ii.ToString()+",_Poke"+si+"Projection);\n";
					}
					else{
						ShaderCode+=		"					float _Poke"+si+"Projection = 1;\n";
						ShaderCode+=		"					float3 _Poke"+si+"LPosition = _Poke"+si+"Position;\n";
						ShaderCode+=		"					float _Poke"+si+"Distance = distance(_Poke"+si+"Position,worldPos);\n";
						ShaderCode+=		"					float3 _Poke"+si+"LVelocity = _Poke"+si+"Velocity;\n";
						ShaderCode+=		"					float _Poke"+si+"LTime = _Poke"+si+"Time;\n";
						ShaderCode+=		"					float _Poke"+si+"LTimeNormalized = _Poke"+si+"TimeNormalized;\n";
						ShaderCode+=		"					float _Poke"+si+"LMaxDistance = _Poke"+si+"MaxDistance;\n";
						
						for(int ii = 0; ii<PokeFloats.Float;ii++)
							ShaderCode+="						float  _Poke"+si+"LCustomF_"+ii.ToString()+" = _Poke"+si+"CustomF_"+ii.ToString()+";\n";
						for(int ii = 0; ii<PokeFloat3s.Float;ii++)
							ShaderCode+="						float3 _Poke"+si+"LCustomF3_"+ii.ToString()+" = _Poke"+si+"CustomF3_"+ii.ToString()+";\n";
					}
					ShaderCode+="\n";
				}
			}
			...
			if (PokeOn.On&&PokeInteraction.Type>0){
				ShaderCode+=			"				//Poke Stuff\n";
				ShaderCode+=			"					Vertex = mul(_Object2World, Vertex);//Temporarily operate in world space...\n";
				for(i = 0; i<PokeCount.Float;i++){
					string si = i.ToString();
					if (PokeInteraction.Type==1){
						ShaderCode+=	"					Vertex.xyz += max(0,1-_Poke"+si+"Distance/_Poke"+si+"LMaxDistance)*_Poke"+si+"LVelocity*_Poke"+si+"LTimeNormalized;\n";
					}
					if (PokeInteraction.Type==2){
						ShaderCode+=	"					Vertex.xyz += max(0,1-_Poke"+si+"Distance/_Poke"+si+"LMaxDistance)*_Poke"+si+"LVelocity*sin(_Poke"+si+"LTime*5)*_Poke"+si+"LTimeNormalized;\n";
					}
					if (PokeInteraction.Type==3){
						ShaderCode+=	"					Vertex.xyz += max(0,sin(_Poke"+si+"LTimeNormalized*3.14)-_Poke"+si+"Distance/_Poke"+si+"LMaxDistance)*_Poke"+si+"LVelocity*sin(_Poke"+si+"LTime*5-_Poke"+si+"Distance*5)*_Poke"+si+"LTimeNormalized;\n";
						//ShaderCode+=	"					Vertex.xyz += max(0,sin(_Poke"+si+"LTimeNormalized*3.14)*0.6-_Poke"+si+"Distance/2)*_Poke"+si+"LVelocity*sin(_Poke"+si+"LTime*5-_Poke"+si+"Distance*5)*_Poke"+si+"LTimeNormalized;\n";
						//Vertex.xyz += max(0,sin(_Poke0TimeNormalized*3.14)-_Poke0Distance/2)*_Poke0Velocity*sin(_Poke0Time*5-_Poke0Distance*5)*_Poke0TimeNormalized;
					}
					ShaderCode+="\n";
				}
				ShaderCode+=			"					Vertex = mul(_World2Object, Vertex);//Back to object space...\n";
			}
			...
			ShaderCode+="				v.vertex.xyz = Vertex.xyz;\n";
			ShaderCode += 	"				o.pos = mul (UNITY_MATRIX_MVP, Vertex);\n";
			...
			if ((MiscVertexLights.On||MiscAmbient.On)&&SG.Pass=="ForwardBase")
				ShaderCode +=
						...
						"				#endif // LIGHTMAP_OFF\n"+
						"				\n";
			if ((MiscVertexLights.On||MiscAmbient.On)&&SG.Pass=="Deferred")
				ShaderCode +=
						//"				#ifndef DYNAMICLIGHTMAP_OFF\n"+
						//"					o.lmap.zw = v.texcoord2.xy * unity_DynamicLightmapST.xy + unity_DynamicLightmapST.zw;\n"+
						//"				#else\n"+
			...
			if (SG.Pass!="ShadowCaster"){
				...
				ShaderCode += "				TRANSFER_SHADOW_CASTER_NORMALOFFSET(o) // pass various bits of shadow information (although mainly just vertex position from what I understand)\n";
			}
			ShaderCode += "				return o;\n";
	...
	public string GenerateFragmentShader(ShaderGenerate SG){
		string ShaderCode = "";
				if (SG.Pass == "ShadowCaster")
				ShaderCode += "			fixed4 GetShadowCasterFragment(v2f_surf IN){\n				SHADOW_CASTER_FRAGMENT(IN)\n			}\n";
		string AdditionalOutputs = "";
		if (SG.OutputsDepth)
			AdditionalOutputs += ", out float outputDepth : SV_Depth";
		if (SG.Pass != "Deferred")
			ShaderCode += 	"			void FragmentShader (v2f_surf IN,\n"+
							"				out fixed4 outputColor : SV_Target"+AdditionalOutputs+") {\n";
		else
			ShaderCode += 	"			void FragmentShader (v2f_surf IN,\n"+
							"				out half4 outDiffuse : SV_Target0,\n"+
							"				out half4 outSpecSmoothness : SV_Target1,\n"+
							"				out half4 outNormal : SV_Target2,\n"+
							"				out half4 outEmission : SV_Target3"+AdditionalOutputs+") {\n";
		if (TransparencyCorrectShadows.On||SG.Pass!="ShadowCaster"){
			ShaderCode += "				UsefulData d;\n";
			...
			if (UsingMetalModel)
				...
				if (IndirectAmbientOcclusionOn.On)
				ShaderCode += "				d.AmbientOcclusion = 1;\n";
				if (IndirectSubsurfaceScatteringOn.On)
				ShaderCode += "				d.SubsurfaceColor = float3(1,0,0);\n";
				
				ShaderCode += "				d.Emission = float4(0,0,0,0);\n";
				ShaderCode+="				d.Smoothness = 0;\n";
				ShaderCode+="				d.LightSmoothness = 0;\n";
			//}
			...
			if (IndirectAmbientOcclusionOn.On&&IndirectAmbientOcclusionRealtime.Type==0){
				ShaderCode += "				d.AmbientOcclusion = d.color.a;\n";
				
				if (IndirectAmbientOcclusionControl.Type==0)
				ShaderCode += 
				"				//Vertex Toastie Support\n"+
				"				#if !defined(ApplyAOToDiffuse)\n";
				
				if (IndirectAmbientOcclusionOptimized.On){
					ShaderCode+="					d.Occlusion *= d.AmbientOcclusion;\n";
				}
				else{
					if (IndirectAmbientOcclusionControl.Type==0)
						ShaderCode+="					d.Occlusion *= (1-(testpow((1-d.AmbientOcclusion),_AOPower)*_AOStrength));\n";
					else
						ShaderCode+="					d.Occlusion *= (1-(testpow((1-d.AmbientOcclusion),"+IndirectAmbientOcclusionPushback.Get()+")*"+IndirectAmbientOcclusionStrength.Get()+"));\n";
				}
			...
			if (SG.Pass == "ShadowCaster"&&SG.UsedViewDir)
			ShaderCode +=
			...
			if (ParallaxOn.On&&SG.UsedParallax){//&&SG.Pass!="ShadowCaster"){
				ShaderCode+=
				...
				if (ParallaxShadows.On&&SG.Pass!="ShadowCaster"){
					ShaderCode+=
					"				//POM Shadowing\n"+
			...
			if (IsPBR){
				...
				if (SpecularOn.On)
					ShaderCode+="				d.Smoothness = "+SpecularHardness.Get()+";\n";//Used to have *2, not sure why...
				else
					ShaderCode+="				d.Smoothness = 0;\n";
			}
				if (SpecularOn.On)
					ShaderCode+="				d.LightSmoothness = "+MaxLightSpecularHardness.Get()+";\n";
				else
					ShaderCode+="				d.LightSmoothness = 0;\n";
			...
			if (SpecularOn.On){
				if (UsingMetalModel)
					ShaderCode += GenerateLayers(SG,ShaderLayersMetallic,"");
				else
			...
			if (IndirectSubsurfaceScatteringOn.On)	
				ShaderCode += GenerateLayers(SG,ShaderLayersSubsurfaceScattering,"");
			...
			if (SG.UseLighting){
				...
				"				#endif\n\n";
				if ((SG.Pass == "ForwardBase"||SG.Pass=="Deferred")&&!SG.U4)
				...
				if (SG.U4&&(SG.Pass == "ForwardBase"||SG.Pass=="Deferred"))
					ShaderCode += 
									"				gi.indirect.diffuse = LinearToGamma(UNITY_LIGHTMODEL_AMBIENT);\n";
				if (SG.U4&&IsPBR&&(SG.Pass == "ForwardBase"||SG.Pass=="Deferred")){
					ShaderCode += 	"				gi.indirect.specular = LinearToGamma(Unity_GlossyEnvironment (_Cube, reflect(d.worldViewDir,worldN), 1-d.Smoothness));\n"+
									"				//gi.indirect.specular =  texCUBE(_Cube, float4(reflect(d.worldViewDir,worldN),3));\n";
				}
				if (MaxLightSpecularHardness.Get()!="1"){
					ShaderCode += "				d.Smoothness = min(d.Smoothness,d.LightSmoothness);\n";
				}
				
				if (IndirectSubsurfaceScatteringOn.On){
					ShaderCode += 
						"				d.Thickness = d.color.a;";
				}
				
				if (SG.Pass=="ForwardAdd")
					ShaderCode += "				c = CalculateLighting (d, gi);\n";
				else if (SG.Pass=="Deferred"){
					ShaderCode += 
					...
					if (ParallaxOn.On&&ParallaxShadows.On){
						ShaderCode += "				outDiffuse.rgb*=d.ShadowFactor;\n";
						ShaderCode += "				outSpecSmoothness.rgb*=d.ShadowFactor;\n";
					}
				}
				else
				...
				if (SG.Pass=="ForwardAdd")
					...
					ShaderCode += "				outEmission = CalculateLighting (d, d.worldViewDir, gi, outDiffuse, outSpecSmoothness, outNormal);\n";
				else
					ShaderCode += "				c = float4(d.Albedo+d.Emission.rgb,d.Alpha+d.Emission.a);\n";
			}
			if (SG.Pass == "Deferred"){
				if (IndirectAmbientOcclusionOn.On){
					if (IndirectAmbientOcclusionControl.Type==0)
					ShaderCode += 
					"				//More Vertex Toastie Support\n"+
					"				#if defined(ApplyAOToDiffuse)\n";
					
					if (IndirectAmbientOcclusionOptimized.On)
					ShaderCode+="					outDiffuse *= d.AmbientOcclusion;\n";
					else{
					if (IndirectAmbientOcclusionControl.Type==0)
						ShaderCode+="					outDiffuse *= (1-(testpow((1-d.AmbientOcclusion),_AOPower)*_AOStrength));\n";
					else
						ShaderCode+="					outDiffuse *= (1-(testpow((1-d.AmbientOcclusion),"+IndirectAmbientOcclusionPushback.Get()+")*"+IndirectAmbientOcclusionStrength.Get()+"));\n";
					}
					if (IndirectAmbientOcclusionControl.Type==0)
					ShaderCode+=
					"				#endif\n";
					...
					if (IndirectAmbientOcclusionOptimized.On)
					ShaderCode+="					outEmission = d.AmbientOcclusion;\n";
					else{
						if (IndirectAmbientOcclusionControl.Type==0)
							ShaderCode+="					outEmission = (1-(testpow((1-d.AmbientOcclusion),_AOPower)));\n";
						else
							ShaderCode+="					outEmission = (1-(testpow((1-d.AmbientOcclusion),"+IndirectAmbientOcclusionPushback.Get()+")));\n";
					}
				...
				if (ShaderSandwich.Instance.OpenShader.MiscColorSpace.Type == 2)
					...
					"					outDiffuse = pow(outDiffuse,2.2);\n"+
					"				#endif\n";			
			}
			else if (SG.Pass != "ShadowCaster"){
				if (MiscFog.On&&!SG.U4)
					ShaderCode += "				UNITY_APPLY_FOG(IN.fogCoord, c); // apply fog;\n";
				if (!TransparencyOn.On||(TransparencyType.Type==0&&!TransparencyAlphaToCoverage.On))
					ShaderCode += "				c.a = 1;\n";
				else if (TransparencyOn.On&&TransparencyType.Type==1&&((BlendMode.Type==1&&(!IsPBR||!TransparencyPBR.On))||(TransparencyPreMult.Type==2)))
					ShaderCode += "				c.rgb *= d.Alpha;\n";
					
				if (IndirectAmbientOcclusionOn.On){
					if (IndirectAmbientOcclusionControl.Type==0||IndirectAmbientOcclusionDisplayType.Type==1){
						if (IndirectAmbientOcclusionControl.Type==0)
						ShaderCode += 
						"				//More Vertex Toastie Support\n"+
						"				#if defined(ApplyAOToDiffuse)\n";
						...
						if (IndirectAmbientOcclusionOptimized.On)
							ShaderCode+="					c.rgb *= d.AmbientOcclusion;\n";
						else{
							if (IndirectAmbientOcclusionControl.Type==0)
								ShaderCode+="					c.rgb *= (1-(testpow((1-d.AmbientOcclusion),_AOPower)*_AOStrength));\n";
							else
								ShaderCode+="					c.rgb *= (1-(testpow((1-d.AmbientOcclusion),"+IndirectAmbientOcclusionPushback.Get()+")*"+IndirectAmbientOcclusionStrength.Get()+"));\n";
						}
					...
					if (IndirectAmbientOcclusionControl.Type==0||IndirectAmbientOcclusionDisplayType.Type==2){
						if (IndirectAmbientOcclusionControl.Type==0)
						ShaderCode+="				#if defined(Visualize_AO)\n";
						
						if (IndirectAmbientOcclusionOptimized.On)
							ShaderCode+="					c.rgb = d.color.a;\n";
						else{
							if (IndirectAmbientOcclusionControl.Type==0)
								ShaderCode+="					c.rgb = (1-(testpow((1-d.color.a),_AOPower)));\n";
							else
								ShaderCode+="					c.rgb = (1-(testpow((1-d.color.a),"+IndirectAmbientOcclusionPushback.Get()+")));\n";
						}
				...
				ShaderCode += "				outputColor = c;\n";
			}
			else{
				ShaderCode += "				c.a-="+TransparencyZWriteAmount.Get()+";\n";
				if (TransparencyCorrectShadows.On)
					ShaderCode += "				clip(c.a);\n";
			}
			if (SG.OutputsDepth){
				ShaderCode+= 	"				float computedDepth = d.screenPos.w;\n";
				if (ParallaxDepthCorrection.On)
				ShaderCode += 	
				"				computedDepth += (d.Depth)*("+ParallaxHeight.Get()+");\n";
				
				ShaderCode+=
				"				outputDepth = (1.0 - computedDepth * _ZBufferParams.w) / (computedDepth * _ZBufferParams.z);\n";
			}
		}
			if (SG.Pass == "ShadowCaster")
				ShaderCode += "				outputColor = GetShadowCasterFragment(IN);\n";
	...
	public string GenerateStructs(ShaderGenerate SG){
		string ShaderCode = "";
			...
			if (SG.Pass=="ForwardBase"||SG.Pass == "ShadowCaster"||SG.Pass == "Deferred"){
				...
				if (SG.Pass == "ForwardBase"||SG.Pass == "Deferred")
					ShaderCode +=
					"					float4 pos : SV_POSITION;\n";
				...
				"					#ifdef LIGHTMAP_OFF\n"+
				"						#if UNITY_SHOULD_SAMPLE_SH\n"+
				"							half3 sh : TEXCOORD"+GetTexCoord(ref TexCoords)+"; // SH\n"+
				"					  	#endif\n"+
				"					  #else\n"+
				"					  	#ifdef DIRLIGHTMAP_OFF\n"+
				"					  		float4 lmapFadePos : TEXCOORD"+GetTexCoord(ref TexCoords)+";\n"+
				"					  	#endif\n"+
				"					  #endif;\n";
				
				
				
				if (SG.Pass!="ShadowCaster"&&MiscShadows.On&&(SG.Pass!="ForwardAdd"||MiscFullShadows.On)&&!SG.U4)
				ShaderCode +=
				"					SHADOW_COORDS("+GetTexCoord(ref TexCoords)+")\n";
				if (SG.Pass!="ShadowCaster"&&MiscFog.On&&!SG.U4)
				ShaderCode +=
				"					UNITY_FOG_COORDS("+GetTexCoord(ref TexCoords)+")\n";
				if (SG.Pass!="ShadowCaster"&&SG.U4)
				ShaderCode +=
	...
	public void GenerateUsed(ShaderGenerate SG){
		...
		SG.OutputsDepth = false;
		
		if (ParallaxDepthCorrection.On){
			SG.OutputsDepth = true;
			SG.UsedScreenPos = true;
		}
			
		SG.UseTangentSpace = SG.PassSetNormals;
		if (MiscVertexToastie.On)
			SG.UsedVertex = true;
		if (IndirectAmbientOcclusionOn.On)
			SG.UsedVertex = true;
		if (IndirectSubsurfaceScatteringOn.On)
		...
		if (DiffuseOn.On){
			if (DiffuseLightingType.Type==1){//Diffuse
				...
				"				cDiff = gi.light.color * NdotL; //Output the final RGB color by multiplying the surfaces color with the light color, then by the distance from the light (or some function of it), and finally by the Dot of the normal and the light direction.\n";
					...
					if (IndirectSubsurfaceScatteringOn.On){
		DiffuseCode += @"
	float3 vLTLight = gi.light.dir + d.Normal * "+IndirectSubsurfaceScatteringDistortion.Get()+@";//distortion;
	float fLTDot = pow(saturate(dot(d.worldViewDir,-vLTLight)),"+IndirectSubsurfaceScatteringThinness.Get()+@") * "+IndirectSubsurfaceScatteringScale.Get()+@";
	float3 fLT = (fLTDot + ("+IndirectSubsurfaceScatteringAmbient.Get()+@"*pow(d.Atten,"+IndirectSubsurfaceScatteringDensity.Get()+@")))" + (IndirectSubsurfaceScatteringUseThickness.On?" * d.Thickness":"")+@" * d.SubsurfaceColor;
	
    cDiff = gi.light.color * lerp(fLT,nl,"+IndirectSubsurfaceScatteringMix.Get()+@");
		";
					}
			}
...
ShaderCode+=@"
	...
	if (SG.U4)
	ShaderCode+="half specularTerm = (V * D) * (3.1415/4); // Torrance-Sparrow model, Fresnel is applied later (for optimization reasons)\n";
	else
	ShaderCode+="half specularTerm = (V * D) * (UNITY_PI/4); // Torrance-Sparrow model, Fresnel is applied later (for optimization reasons)\n";
...
";
    ...
    cDiff = gi.light.color * disneyDiffuse* lerp(fLT,nl,"+IndirectSubsurfaceScatteringMix.Get()+@");
		";
	}
	if (ParallaxOn.On&&ParallaxShadows.On){
		ShaderCode += 
...
half4 BRDF2_Unity_PBSSS (UsefulData d, UnityGI gi,half oneMinusReflectivity, half oneMinusRoughness)
{
	...
	float3 vLTLight = gi.light.dir + d.Normal * "+IndirectSubsurfaceScatteringDistortion.Get()+@";//distortion;
	float fLTDot = pow(saturate(dot(d.worldViewDir,-vLTLight)),"+IndirectSubsurfaceScatteringThinness.Get()+@") * "+IndirectSubsurfaceScatteringScale.Get()+@";
	float3 fLT = (fLTDot + ("+IndirectSubsurfaceScatteringAmbient.Get()+@"))" + (IndirectSubsurfaceScatteringUseThickness.On?" * d.Thickness":"")+@" * d.SubsurfaceColor;
...
";
			...
			if (SG.Pass=="Deferred")
				ShaderCode += "float4 CalculateLighting(UsefulData d, half3 viewDir, UnityGI gi, out half4 outDiffuseOcclusion, out half4 outSpecSmoothness, out half4 outNormal){\n";
			else
			ShaderCode += 
			...
			if (DiffuseLightingType.Type>0||!DiffuseOn.On){//Anything that ain't pbr
				...
				if (UsingMetalModel)
					ShaderCode += 	"half3 specColor;\n"+
									"				d.Albedo = DiffuseAndSpecularFromMetallic (d.Albedo, d.Metallic, /*out*/ specColor, /*out*/ oneMinusReflectivity);\n"+
									"d.Specular = specColor;\n";
				else
					ShaderCode += "				d.Albedo = EnergyConservationBetweenDiffuseAndSpecular (d.Albedo, d.Specular, /*out*/ oneMinusReflectivity);\n";
				ShaderCode += "				\n"+
	...
	public string GenerateTags(ShaderGenerate SG){
		...
		if (!SG.Wireframe){
			...
			if (SG.Pass == "Mask"||SG.Pass == "ShadowCaster")
					ShaderCode+="	ZWrite On\n";
			if (TransparencyOn.On&&TransparencyType.Type==1&&SG.Pass != "ShadowCaster"){
				if (SG.Pass != "Mask")
					ShaderCode+="	ZWrite Off\n";
				
				if (BlendMode.Type==0){
					if (SG.Pass == "ForwardBase"){
						if ((TransparencyPBR.On&&IsPBR)||TransparencyPreMult.Type>0||TransparencyPreMult2.On)
			...
			if (TechZWrite.Type==1)
				ShaderCode+="	ZWrite On\n";
			else
			if (TechZWrite.Type==2)
				ShaderCode+="	ZWrite Off\n";
		}
		if (SG.Pass == "Mask")
	...
	public string GenerateShadowCasterPass(ShaderGenerate SG){
		GenerateUsed(SG);
		string ShaderCode = "";
		if (ShaderLayersVertex.SLs.Count>0||TransparencyCorrectShadows.On){
			SG.Pass = "ShadowCaster";
			SG.UseLighting = false;
			ShaderCode += GeneratePassStart(SG,"ShadowCaster","ShadowCaster","multi_compile_shadowcaster","SHADERSANDWICH_SHADOWCASTER")+"\n";
			ShaderCode += GenerateUniforms(SG)+"\n";
			ShaderCode += GenerateStructs(SG)+"\n";
			ShaderCode += GenerateFunctions(SG)+"\n";
			ShaderCode += GenerateVertexShader(SG)+"\n";
	...
	public string GenerateDeferred(ShaderGenerate SG){
		GenerateUsed(SG);
		string ShaderCode = "";
			SG.Pass = "Deferred";
			ShaderCode += GeneratePassStart(SG,"DEFERRED","Deferred","multi_compile_prepassfinal\n				#pragma skip_variants FOG_LINEAR FOG_EXP FOG_EXP2","UNITY_PASS_DEFERRED"," nomrt")+"\n";
			ShaderCode += GenerateUniforms(SG)+"\n";
			ShaderCode += GenerateStructs(SG)+"\n";
			ShaderCode += GenerateFunctions(SG)+"\n";
			ShaderCode += GenerateVertexShader(SG)+"\n";
...
"			\n";
		...
		if (PokeOn.On&&PokeLine.On){
			...
			";
			if (PokeCustom.On){
				string FunctionHeader = "(UsefulData d, UnityGI gi,float _PokeProjection, float3 _PokeLPosition, float3 _PokeLVelocity, float _PokeDistance, float _PokeLTime, float _PokeLTimeNormalized, float _PokeLMaxDistance";
				for(int i = 0; i<PokeFloats.Float;i++){
					FunctionHeader+=", float _PokeCustomF_"+i.ToString();
				}
				for(int i = 0; i<PokeFloat3s.Float;i++){
					FunctionHeader+=", float3 _PokeCustomF3_"+i.ToString();
				}
				FunctionHeader+="){\n";
				//float4 FragmentPokeFunction(UsefulData d, UnityGI gi,float _PokeProjection, float3 _PokeLPosition, float3 _PokeLVelocity, float _PokeDistance, float _PokeLTime, float _PokeLTimeNormalized, float _PokeLMaxDistance,_PokeCustomF_0,_PokeCustomF3_0)
				shaderCode+="float4 PokeFunction1"+FunctionHeader;
				shaderCode+="				float4 PokeChan1 = 1;\n";
				
				shaderCode+=GenerateLayers(SG,ShaderLayersFragmentPoke,"");
				
				shaderCode+="				return PokeChan1;\n";
				...
				//float4 FragmentPokeFunction(UsefulData d, UnityGI gi,float _PokeProjection, float3 _PokeLPosition, float3 _PokeLVelocity, float _PokeDistance, float _PokeLTime, float _PokeLTimeNormalized, float _PokeLMaxDistance,_PokeCustomF_0,_PokeCustomF3_0)
				shaderCode+="float4 PokeFunction2"+FunctionHeader;
				shaderCode+="				float4 PokeChan2 = 1;\n";
				
				shaderCode+=GenerateLayers(SG,ShaderLayersVertexPoke,"");
				
				shaderCode+="				return PokeChan2;\n";
