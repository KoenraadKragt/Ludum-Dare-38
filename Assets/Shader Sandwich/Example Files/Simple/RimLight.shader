...
Properties {
	...
	_SSSRim_Color ("Rim Color", Color) = (0,0.4988508,1,1)
	_SSSRim_Thickness ("Rim Thickness", Range(0.800000000,4.000000000)) = 1.990000000
}
	...
	Cull Back//Culling specifies which sides of the models faces to hide.
		...
		CGPROGRAM
			...
			//Make our inputs accessible by declaring them here.
				...
				sampler2D _MainTex;
float4 _MainTex_ST;
				float4 _SSSRim_Color;
				float _SSSRim_Thickness;
	...
	//Generate layers for the Emission channel.
		//Generate Layer: Rim Light
			//Sample parts of the layer:
				half4 Rim_LightEmission_Sample1 = lerp(float4(0, 0, 0, 1), _SSSRim_Color, (((1-(dot(d.Normal, d.viewDir))))));

			//Apply Effects:
				Rim_LightEmission_Sample1.rgb = clamp(Rim_LightEmission_Sample1.rgb,0,1);
				Rim_LightEmission_Sample1.rgb = pow(Rim_LightEmission_Sample1.rgb,_SSSRim_Thickness);

			//Set the channel to the new color
				d.Emission = Rim_LightEmission_Sample1.rgba;
...
Color#!S2#^Vec#^0.7647059,0.7647059,0.7647059,1#^CC0#?Color
...
VisName#!S2#^Text#^Base (RGB)#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
...
BeginShaderInput
Type#!S2#^Float#^1#^CC0#?Type
VisName#!S2#^Text#^Rim Color#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0,0.4988508,1,1#^CC0#?Color
Number#!S2#^Float#^0#^CC0#?Number
Range0#!S2#^Float#^0#^CC0#?Range0
Range1#!S2#^Float#^1#^CC0#?Range1
...
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSRim_Color#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
BeginShaderInput
Type#!S2#^Float#^4#^CC0#?Type
VisName#!S2#^Text#^Rim Thickness#^CC0#?VisName
ImageDefault#!S2#^Float#^0#^CC0#?ImageDefault
Image#!S2#^Text#^#^CC0#?Image
Cube#!S2#^Text#^#^CC0#?Cube
Color#!S2#^Vec#^0.8,0.8,0.8,1#^CC0#?Color
Number#!S2#^Float#^1.99#^CC0#?Number
Range0#!S2#^Float#^0.8#^CC0#?Range0
Range1#!S2#^Float#^4#^CC0#?Range1
MainType#!S2#^Float#^0#^CC0#?MainType
SpecialType#!S2#^Float#^0#^CC0#?SpecialType
InEditor#!S2#^Float#^1#^CC0#?InEditor
NormalMap#!S2#^Float#^0#^CC0#?NormalMap
CustomFallback#!S2#^Text#^_SSSRim_Thickness#^CC0#?CustomFallback
CustomSpecial#!S2#^Text#^1#^CC0#?CustomSpecial
EndShaderInput
ShaderName#!S2#^Text#^Shader Sandwich/Tutorials/RimLight#^CC0#?ShaderName
...
Main Color#!S2#^Vec#^0.7647059,0.7647059,0.7647059,1#^CC0 #^ 0#?Main Color
...
Color#!S2#^Vec#^0.7647059,0.7647059,0.7647059,1#^CC0 #^ 0#?Color
...
BeginShaderLayer
Layer Name#!S2#^Text#^Rim Light#^CC0#?Layer Name
Real Layer Type#!S2#^Text#^SLTGradient#^CC0#?Real Layer Type
Layer Type#!S2#^Type#^1#^CC0#?Layer Type
Main Color#!S2#^Vec#^0,0.4988508,1,1#^CC0 #^ 2#?Main Color
Second Color#!S2#^Vec#^0,0,0,1#^CC0#?Second Color
Main Texture#!S2#^Texture#^#^CC0#?Main Texture
NCubemap#!S2#^Cubemap#^#^CC0#?NCubemap
Noise Type#!S2#^Type#^0#^CC0#?Noise Type
...
Cubemap#!S2#^Cubemap#^#^CC0#?Cubemap
Noise Dimensions#!S2#^Type#^0#^CC0#?Noise Dimensions
Color#!S2#^Vec#^0,0.4988508,1,1#^CC0 #^ 2#?Color A
...
IsVisible#!S2#^Toggle#^True#^CC0#?IsVisible
UseAlpha#!S2#^Float#^0#^CC0#?UseAlpha
Power#!S2#^Float#^1.99#^CC0 #^ 3#?Power
EndShaderEffect
BeginShaderEffect
