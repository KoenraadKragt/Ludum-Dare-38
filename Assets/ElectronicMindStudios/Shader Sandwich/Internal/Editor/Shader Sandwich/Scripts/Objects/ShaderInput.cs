...
public enum InputMainTypes {None,MainColor,MainTexture,BumpMap,MainCubemap,SpecularColor,Shininess,ReflectColor,Parallax,ParallaxMap,Cutoff,ShellDistance,TerrainControl,TerrainSplat0,TerrainSplat1,TerrainSplat2,TerrainSplat3,TerrainNormal0,TerrainNormal1,TerrainNormal2,TerrainNormal3,Custom};
public enum InputSpecialTypes {None,Time,TimeFast,TimeSlow,TimeVerySlow,SinTime,SinTimeFast,SinTimeSlow,CosTime,CosTimeFast,CosTimeSlow,ShellDepth,ParallaxDepth,ClampedSinTime,ClampedSinTimeFast,ClampedSinTimeSlow,ClampedCosTime,ClampedCosTimeFast,ClampedCosTimeSlow,Custom,Mask};
[System.Serializable]
public class ShaderInput : ScriptableObject{// : UnityEngine.Object{
	...
	public ShaderVar Mask = new ShaderVar("Mask","ListOfObjects");
