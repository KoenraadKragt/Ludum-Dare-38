...
Shader "CustomPokeExample" {//The Shaders Name
...
SubShader {
	Tags { "RenderType"="Opaque" "Queue"="Geometry""SSPoke" = "Yes"  }//A bunch of settings telling Unity a bit about the shader.
	LOD 200
AlphaToMask Off
	Pass {
		Name "FORWARD"
		Tags { "LightMode" = "ForwardBase" "SSPoke" = "Yes" }
	ZTest LEqual
...
float PokeLineProjection(float3 P1, float3 P2, float3 pos){
			...
			float4 PokeFunction1(UsefulData d, UnityGI gi,float _PokeProjection, float3 _PokeLPosition, float3 _PokeLVelocity, float _PokeDistance, float _PokeLTime, float _PokeLTimeNormalized, float _PokeLMaxDistance){
				float4 PokeChan1 = 1;
	//Generate layers for the Pixel Poke channel.
		//Generate Layer: Pixel Poke2
			//Sample parts of the layer:
				half4 Pixel_Poke2FragmentPoke_Sample1 = float4(_PokeDistance,_PokeDistance,_PokeDistance,0);

			//Set the channel to the new color
				PokeChan1 = Pixel_Poke2FragmentPoke_Sample1.rgba;

		//Generate Layer: Pixel Poke2 Copy 2
			//Sample parts of the layer:
				half4 Pixel_Poke2_Copy_2FragmentPoke_Sample1 = float4(_PokeLMaxDistance,_PokeLMaxDistance,_PokeLMaxDistance,1);

			//Blend the layer into the channel using the Divide blend mode
				PokeChan1 /= Pixel_Poke2_Copy_2FragmentPoke_Sample1.rgba;

		//Generate Layer: Pixel Poke4
			//Sample parts of the layer:
				half4 Pixel_Poke4FragmentPoke_Sample1 = PokeChan1;

			//Apply Effects:
				Pixel_Poke4FragmentPoke_Sample1.rgb = clamp(Pixel_Poke4FragmentPoke_Sample1.rgb,0,1);
				Pixel_Poke4FragmentPoke_Sample1.rgb = (float3(1,1,1)-Pixel_Poke4FragmentPoke_Sample1.rgb);

			//Set the channel to the new color
				PokeChan1 = Pixel_Poke4FragmentPoke_Sample1.rgba;

		//Generate Layer: Pixel Poke5 Copy 2
			//Sample parts of the layer:
				half4 Pixel_Poke5_Copy_2FragmentPoke_Sample1 = float4(_PokeLVelocity,0);

			//Blend the layer into the channel using the Multiply blend mode
				PokeChan1 *= Pixel_Poke5_Copy_2FragmentPoke_Sample1.rgba;

		//Generate Layer: Pixel Poke5
			//Sample parts of the layer:
				half4 Pixel_Poke5FragmentPoke_Sample1 = float4(_PokeLTimeNormalized,_PokeLTimeNormalized,_PokeLTimeNormalized,0);

			//Apply Effects:
				Pixel_Poke5FragmentPoke_Sample1.rgb = (Pixel_Poke5FragmentPoke_Sample1.rgb*9.42);
				Pixel_Poke5FragmentPoke_Sample1.rgb = (Pixel_Poke5FragmentPoke_Sample1.rgb+3.14);
				Pixel_Poke5FragmentPoke_Sample1.rgb = sin(Pixel_Poke5FragmentPoke_Sample1.rgb);

			//Blend the layer into the channel using the Multiply blend mode
				PokeChan1 *= Pixel_Poke5FragmentPoke_Sample1.rgba;

		//Generate Layer: Pixel Poke5 Copy
			//Sample parts of the layer:
				half4 Pixel_Poke5_CopyFragmentPoke_Sample1 = float4(_PokeLTimeNormalized,_PokeLTimeNormalized,_PokeLTimeNormalized,0);

			//Blend the layer into the channel using the Multiply blend mode
				PokeChan1 *= Pixel_Poke5_CopyFragmentPoke_Sample1.rgba;
...
float4 PokeFunction2(UsefulData d, UnityGI gi,float _PokeProjection, float3 _PokeLPosition, float3 _PokeLVelocity, float _PokeDistance, float _PokeLTime, float _PokeLTimeNormalized, float _PokeLMaxDistance){
	...
	Vertex.xyz = mul(unity_ObjectToWorld,Vertex.xyz);
		//Generate Layer: Vertex2
			//Sample parts of the layer:
				half4 Vertex2Vertex_Sample1 = PokeFunction1(d, gi,_Poke0Projection, _Poke0LPosition, _Poke0LVelocity, _Poke0Distance, _Poke0LTime, _Poke0LTimeNormalized, _Poke0LMaxDistance) + PokeFunction1(d, gi,_Poke1Projection, _Poke1LPosition, _Poke1LVelocity, _Poke1Distance, _Poke1LTime, _Poke1LTimeNormalized, _Poke1LMaxDistance) + PokeFunction1(d, gi,_Poke2Projection, _Poke2LPosition, _Poke2LVelocity, _Poke2Distance, _Poke2LTime, _Poke2LTimeNormalized, _Poke2LMaxDistance) + PokeFunction1(d, gi,_Poke3Projection, _Poke3LPosition, _Poke3LVelocity, _Poke3Distance, _Poke3LTime, _Poke3LTimeNormalized, _Poke3LMaxDistance) + PokeFunction1(d, gi,_Poke4Projection, _Poke4LPosition, _Poke4LVelocity, _Poke4Distance, _Poke4LTime, _Poke4LTimeNormalized, _Poke4LMaxDistance) + PokeFunction1(d, gi,_Poke5Projection, _Poke5LPosition, _Poke5LVelocity, _Poke5Distance, _Poke5LTime, _Poke5LTimeNormalized, _Poke5LMaxDistance) + PokeFunction1(d, gi,_Poke6Projection, _Poke6LPosition, _Poke6LVelocity, _Poke6Distance, _Poke6LTime, _Poke6LTimeNormalized, _Poke6LMaxDistance) + PokeFunction1(d, gi,_Poke7Projection, _Poke7LPosition, _Poke7LVelocity, _Poke7Distance, _Poke7LTime, _Poke7LTimeNormalized, _Poke7LMaxDistance) + PokeFunction1(d, gi,_Poke8Projection, _Poke8LPosition, _Poke8LVelocity, _Poke8Distance, _Poke8LTime, _Poke8LTimeNormalized, _Poke8LMaxDistance) + PokeFunction1(d, gi,_Poke9Projection, _Poke9LPosition, _Poke9LVelocity, _Poke9Distance, _Poke9LTime, _Poke9LTimeNormalized, _Poke9LMaxDistance);

			//Blend the layer into the channel using the Add blend mode
				Vertex += Vertex2Vertex_Sample1.rgba;

	//Transform back into object space
	Vertex.xyz = mul(unity_WorldToObject,Vertex.xyz);
				Vertex.w = v.vertex.w;
...
AlphaToMask Off
	Pass {
		Name "FORWARD"
		Tags { "LightMode" = "ForwardAdd" "SSPoke" = "Yes" }
	Fog { Color (0,0,0,0) }
	ZTest LEqual
...
AlphaToMask Off
	Pass {
		Name "DEFERRED"
		Tags { "LightMode" = "Deferred" "SSPoke" = "Yes" }
	ZTest LEqual
	Cull Back//Culling specifies which sides of the models faces to hide.
...
AlphaToMask Off
	Pass {
		Name "ShadowCaster"
		Tags { "LightMode" = "ShadowCaster" "SSPoke" = "Yes" }
	ZTest LEqual
	ZWrite On
	Cull Back//Culling specifies which sides of the models faces to hide.
...
Mask#!S2#^ObjectArray#^-1#^CC0#?Mask
EndShaderInput
ShaderName#!S2#^Text#^CustomPokeExample#^CC0#?ShaderName
...
Specular Type#!S2#^Type#^0#^CC0#?Specular Type
Spec Hardness#!S2#^Float#^0.3947974#^CC0#?Spec Hardness
...
Poke Interaction#!S2#^Type#^0#^CC0#?Poke Interaction
...
Color#!S2#^Vec#^0.627451,0.8,0.8823529,1#^CC0 #^ 1#?Color
EndShaderLayer
BeginShaderLayer
...
EndTag#!S2#^Text#^rgba#^CC0#?EndTag
BeginShaderLayer
Layer Name#!S2#^Text#^Vertex2#^CC0#?Layer Name
Real Layer Type#!S2#^Text#^SLTPokeData2#^CC0#?Real Layer Type
Layer Type#!S2#^Type#^0#^CC0#?Layer Type
...
Vertex Space#!S2#^Float#^1#^CC0#?Vertex Space
Color#!S2#^Vec#^0.627451,0.8,0.8823529,1#^CC0#?Color
PokeChannel#!S2#^Type#^0#^CC0#?PokeChannel
ApplyInWorldSpace#!S2#^Toggle#^True#^CC0#?ApplyInWorldSpace
EndShaderLayer
EndShaderLayerList
BeginShaderLayerList
...
EndTag#!S2#^Text#^rgba#^CC0#?EndTag
BeginShaderLayer
Layer Name#!S2#^Text#^Pixel Poke2#^CC0#?Layer Name
Real Layer Type#!S2#^Text#^SLTPokeData#^CC0#?Real Layer Type
Layer Type#!S2#^Type#^0#^CC0#?Layer Type
Main Color#!S2#^Vec#^1,1,1,1#^CC0#?Main Color
Second Color#!S2#^Vec#^0,0,0,1#^CC0#?Second Color
Main Texture#!S2#^Texture#^#^CC0#?Main Texture
...
Vertex Space#!S2#^Float#^0#^CC0#?Vertex Space
Color#!S2#^Vec#^0.627451,0.8,0.8823529,1#^CC0#?Color
PokeCustomAttr#!S2#^Float#^0#^CC0#?PokeCustomAttr
PokeData#!S2#^Type#^3#^CC0#?PokeData
EndShaderLayer
BeginShaderLayer
Layer Name#!S2#^Text#^Pixel Poke2 Copy 2#^CC0#?Layer Name
Real Layer Type#!S2#^Text#^SLTPokeData#^CC0#?Real Layer Type
Layer Type#!S2#^Type#^0#^CC0#?Layer Type
Main Color#!S2#^Vec#^1,1,1,1#^CC0#?Main Color
Second Color#!S2#^Vec#^0,0,0,1#^CC0#?Second Color
...
Fadeout Start#!S2#^Float#^3#^CC0#?Fadeout Start
Fadeout End#!S2#^Float#^5#^CC0#?Fadeout End
Mix Type#!S2#^Type#^4#^CC0#?Mix Type
Stencil#!S2#^ObjectArray#^-1#^CC0#?Stencil
